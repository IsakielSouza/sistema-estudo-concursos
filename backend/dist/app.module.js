...
const mobile_logging_interceptor_1 = require("./common/interceptors/mobile-logging.interceptor");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: core_1.APP_INTERCEPTOR,
                useClass: mobile_logging_interceptor_1.MobileLoggingInterceptor,
            },
        ],
    })
], AppModule);
