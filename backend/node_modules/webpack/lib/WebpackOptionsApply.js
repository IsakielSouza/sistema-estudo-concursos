...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/isakiel/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20419d4b691db20d54beffAR8IVARMBANTV1QDUV0NVQZUVFMA', mode: 'build'}); } catch(cjsError) { try { import('file:///home/isakiel/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20419d4b691db20d54beffAR8IVARMBANTV1QDUV0NVQZUVFMA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
